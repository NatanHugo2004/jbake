...
/**
 * Renders documents from the content store using the configured template engine.
 *
 * <p>This renderer processes unrendered content, handles individual document
 * navigation metadata (previous and next documents), and tracks rendering failures.
 */
