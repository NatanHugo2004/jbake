 ...
 * to HTML already.
 *
 *<p>An appropriate rendering engine will be chosen by JBake based on the template suffix. If
 ...
 *
 * <p>Note that some rendering engines may rely on a different rendering model than the one
...
public abstract class AbstractTemplateEngine {
  ...
  /**
   * Initializes a new {@code AbstractTemplateEngine}.
   *
